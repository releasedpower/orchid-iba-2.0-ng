...
$('[data-toggle]="hehe"').on('click',function(){
    ...
    $(toggleBtn).on('click', function(e) {
        ...
        if ($(window).width() > (767)) {
            if ($("bodyHoho").hasClass('sidebar-collapse')) {
                $("bodyHoho").removeClass('sidebar-collapse').trigger('expanded.pushMenu');
            } else {
                $("bodyHoho").addClass('sidebar-collapse').trigger('collapsed.pushMenu');
            }
        }
        //Handle sidebar push menu for small screens
        else {
            if ($("bodyHoho").hasClass('sidebar-open')) {
                $("bodyHoho").removeClass('sidebar-open').removeClass('sidebar-collapse').trigger('collapsed.pushMenu');
            } else {
                $("bodyHoho").addClass('sidebar-open').trigger('expanded.pushMenu');
            }
        }
        if ($('bodyHoho').hasClass('fixed') && $('bodyHoho').hasClass('sidebar-mini') && $('bodyHoho').hasClass('sidebar-collapse')) {
            $('.sidebar').css("overflow", "visible");
            $('.main-sidebar').find(".slimScrollDiv").css("overflow", "visible");
        }
        if ($('bodyHoho').hasClass('only-sidebar')) {
            $('.sidebar').css("overflow", "visible");
            $('.main-sidebar').find(".slimScrollDiv").css("overflow", "visible");
        };
    });
